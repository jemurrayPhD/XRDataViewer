    ...
    def __init__(self, parameters: Iterable[ParameterDefinition], parent=None):
        ...
        for definition in self._definitions:
            ...
            if definition.kind == "float":
                ...
                spin.valueChanged.connect(self.parametersChanged.emit)
                widget = spin
                ...
                spin_i.valueChanged.connect(self.parametersChanged.emit)
                widget = spin_i
                ...
                combo.currentIndexChanged.connect(self.parametersChanged.emit)
                widget = combo
            else:
                line = QtWidgets.QLineEdit(str(definition.default))
                line.textChanged.connect(self.parametersChanged.emit)
                widget = line
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.tab_multiview = MultiViewGrid()
